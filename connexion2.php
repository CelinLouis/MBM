		...
		<div>
			...
			<form id="form_login" method="POST" action="">
				<div>
					...
					<a href="acc_password.html" class="forgot-password-link ">Mot de passe oublié ?</a>
	...
	$.post('controller/auth_controller.php',
		...
		function(data)
		{
			...
			$("#error_show").text("");
				...
				{
					$("#error_show").hide();
					$("#success_show").append("Connexion réussie");
					...
					setTimeout(function()
					{
						...
						{
							//alert("moncopte");
							window.location.href='moncompte/profile.php';
						}, 1000);
					}, 2000);
				}
				else if(data== "error1")

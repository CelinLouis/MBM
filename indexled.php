...
<div class="container-100 categories">
	...
	<ul>
		<li class="title-cat"><a href="annonces/offres/Vehicules.html">Vehicules</a></li>
		<?php
           $select_categorie_vehicules = "SELECT an_souscat.id as id,an_souscat.label as label  FROM an_categorie,an_souscat WHERE an_categorie.id = an_souscat.id_cat AND an_categorie.id = 1";
		$categorie_vehicules = $conn->query($select_categorie_vehicules);
           while ($res_vehicules =$categorie_vehicules->fetch_assoc() ) {
	?>
        <li><a href="listes-annoncesO.php?categorie=<?php echo $res_vehicules['id'];?>"><?php echo $res_vehicules['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
		<li class="title-cat"><a href="annonces/offres/Se-loger.html">Se loger</a></li>
		<?php
           $select_categorie_loger = "SELECT an_souscat.id as id,an_souscat.label as label  FROM an_categorie,an_souscat WHERE an_categorie.id = an_souscat.id_cat AND an_categorie.id = 2";
		$categorie_loger = $conn->query($select_categorie_loger);
           while ($res_loger =$categorie_loger->fetch_assoc() ) {
	?>
        <li><a href="listes-annoncesO.php?categorie=<?php echo $res_loger['id'];?>"><?php echo $res_loger['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
		<li class="title-cat"><a href="annonces/offres/Emploi.html">Emploi</a></li>
	<?php
           $select_categorie_emploi = "SELECT an_souscat.id as id,an_souscat.label as label  FROM an_categorie,an_souscat WHERE an_categorie.id = an_souscat.id_cat AND an_categorie.id = 3";
		$categorie_emploi = $conn->query($select_categorie_emploi);
           while ($res_emploi =$categorie_emploi->fetch_assoc() ) {
	?>
        <li><a href="listes-annoncesO.php?categorie=<?php echo $res_emploi['id'];?>"><?php echo $res_emploi['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
		<li class="title-cat"><a href="annonces/offres/Mode.html">Mode</a></li>
		<?php
           $select_categorie_mode = "SELECT an_souscat.id as id,an_souscat.label as label FROM an_categorie,an_souscat WHERE an_categorie.id = an_souscat.id_cat AND an_categorie.id = 4";
		$categorie_mode = $conn->query($select_categorie_mode);
           while ($res_mode =$categorie_mode->fetch_assoc() ) {
		?>
        <li><a href="listes-annoncesO.php?categorie=<?php echo $res_mode['id'];?>"><?php echo $res_mode['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
			<li class="title-cat"><a href="annonces/offres/Hi-tech.html">Hi-tech</a></li>
	<?php
           $select_categorie_hiteck = "SELECT an_souscat.id as id,an_souscat.label as label FROM an_categorie,an_souscat WHERE an_categorie.id = an_souscat.id_cat AND an_categorie.id = 5";
		$categorie_hiteck = $conn->query($select_categorie_hiteck);
           while ($res_hiteck =$categorie_hiteck->fetch_assoc() ) {
		?>
        <li><a href="listes-annoncesO.php?categorie=<?php echo $res_hiteck['id'];?>"><?php echo $res_hiteck['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
		<li class="title-cat"><a href="annonces/offres/Habitation.html">Habitation</a></li>
	<?php
           $select_categorie_habitation = "SELECT an_souscat.id as id,an_souscat.label as label FROM an_categorie,an_souscat WHERE an_categorie.id = an_souscat.id_cat AND an_categorie.id = 6";
		 $categorie_habitation = $conn->query($select_categorie_habitation);
           while ($res_habitation =$categorie_habitation->fetch_assoc() ) {
		?>
        <li><a href="listes-annoncesO.php?categorie=<?php echo $res_habitation['id'];?>"><?php echo $res_habitation['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
		<li class="title-cat"><a href="annonces/offres/Loisirs-et-divertis-.html">Loisirs et divertis.</a></li>
	<?php
           $select_categorie_losirs = "SELECT an_souscat.id as id,an_souscat.label as label FROM an_categorie,an_souscat WHERE an_categorie.id = an_souscat.id_cat AND an_categorie.id = 7";
           $categorie_losirs = $conn->query($select_categorie_losirs);
           while ($res_losirs =$categorie_losirs->fetch_assoc() ) {
		?>
        <li><a href="listes-annoncesO.php?categorie=<?php echo $res_losirs['id'];?>"><?php echo $res_losirs['label'];?></a></li>
		<?php } ?>
	</ul>
</nav>
</div>

   ...
   if(isset($_POST["minimum_price"], $_POST["maximum_price"]) && !empty($_POST["minimum_price"]) && !empty($_POST["maximum_price"]))
	...
	if ($isa > 0) {
		//$total_row = $statement->rowCount();
			...
			<a href="connexion.php" data-heart="1" data-id="16" class="icon-heart "></a>
	...
	<div class="list-premium">	
			<a href="../../../annonce/Occitanie-Herault-Ventes-mais-appart-Villa-de-haut-standing-dans-residence-7.html" class="background-ads-premium">
				...
				<img src="images/image-gallery/12.jpg"  alt="" /><div class="bloc-premium-infos"><p>Villa de haut...<br /><span class="txt-info-premium">Occitanie</span><br /><span class="txt-price-premium"><strong>2 980 000,00 €</strong></span></p></div>				
			</a>	
			<a href="../../../annonce/Occitanie-Herault-Ventes-mais-appart-Villa-de-haut-standing-dans-residence-7.html" class="background-ads-premium">

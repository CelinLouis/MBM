...
<div class="container-100">
	<div class="container-100-child search-results-container   margin-bottom">
			...
			<select id="an_region" name="an_region" onchange="">
			 ...
			 <span id="get_counties"></span><span id="cat-search">
				...
				<ul id="search-ads" class="search-ul-checkbox" style="display: block">
					...
					<li>
						<input type="checkbox" id="picture" name="common_selector picture" value="1"  />
						<label for="picture">Annonces avec photo</label>
					</li>
				</ul>
				<div class="downdrop">
					<button onclick="show_hide_prix()" class="btn btn-primary">Prix</button>
					<button onclick="show_hide_plus()" class="btn btn-primary option-1 option-2
                    option-8 option-9 option-11 option-12 option-10 option-14 option-13 option-15">Plus de Filtre</button>
				</div>
				...
				<script type="text/javascript">
					function show_hide_prix(){
						var click = document.getElementById("contenu");
		...
		<div style="display: none;" class="search-form" id="contenu">
		...
		<div style="display: none;" class="search-form" id="plus">
			
					<div class="list-group option-1">
                        <h3>Kilométrage</h3>
					...
					<div class="list-group option-1 option-2">
                        <h3>Année</h3>
					...
					<div class="list-group option-2">
					 ...
					 <div class="list-group option-8 option-9 option-11 option-12 option-10 option-14 option-13 option-15">
                        <h3>Surface</h3>
					...
					<div class="list-group option-8 option-9 option-11 option-12 option-13 option-15">
                        <h3>Pièces</h3>
					...
					<div class="list-group option-8 option-9 option-11 option-12">
                        <h3>Capacité</h3>
...
<script>
	$(document).ready(function(){
	    ...
	    function filter_data(page)
	    {
	        ...
	        var picture = get_filter('picture');

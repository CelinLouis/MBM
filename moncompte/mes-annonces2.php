...
<style type="text/css">
    ...
    <div class="container-100-child" style="height: 1024px;">
                                            ...
                                            <tr class="odd gradeX background-ads-listing-container" style="text-align: center;">
                                                ...
                                                <td>
                                                    <p class="title-listing" style="margin-top:40px;">
                                                       <a href="../annonce-detail.php?an=<?php echo $row['id']; ?>" class="btn btn-primary" title="Modifier"><i class="fa fa-edit"></i>
                                                       </a>
                                        ...
                                        <tbody>
                                            ...
                                            <tr class="odd gradeX background-ads-listing-container" style="text-align: center;">
                                                ...
                                                <td>
                                                    <p class="title-listing" style="margin-top:40px;">
                                                        dsqjhgdqs
                                                       <a  class="btn btn-primary" title="Modifier"><i class="fa fa-edit"></i> Modifier
                                                       </a>

				...
				<div class="container-100">
						<div class="container-100-child">
							...
							<div>
								...
								<center><a href="listes-annonces.php" class="btn button">Lancer mes recherches </a></center>
							</div>
...
<div class="index " >
		...
		<ul id="regions_list">
			<li><a href="listes-annonces.php?region=1" data-id="1">Alaotra-Mangoro</a></li>
			<li><a href="listes-annonces.php?region=2" data-id="2">Amoron'i Mania</a></li>
			<li><a href="listes-annonces.php?region=3" data-id="3">Analanjirofo</a></li>
			<li><a href="listes-annonces.php?region=4" data-id="4">Androy</a></li>
			<li><a href="listes-annonces.php?region=5" data-id="5">Anosy</a></li>
			<li><a href="listes-annonces.php?region=6" data-id="6">Analamanga</a></li>
			<li><a href="listes-annonces.php?region=7" data-id="7">Atsimo-Andrefana</a></li>
			<li><a href="listes-annonces.php?region=8" data-id="8">Atsimo-Atsinanana</a></li>
			<li><a href="listes-annonces.php?region=9" data-id="9">Atsinanana</a></li>
			<li><a href="listes-annonces.php?region=10" data-id="10">Betsiboka</a></li>
			<li><a href="listes-annonces.php?region=11" data-id="11">Boeny</a></li>
			<li><a href="listes-annonces.php?region=12" data-id="12">Bongolava</a></li>
			<li><a href="listes-annonces.php?region=13" data-id="13">Diana</a></li>
			<li><a href="listes-annonces.php?region=14" data-id="14">Haute Matsiatra</a></li>
			<li><a href="listes-annonces.php?region=15" data-id="15">Ihorombe</a></li>
			<li><a href="listes-annonces.php?region=16" data-id="16">Itasy</a></li>
			<li><a href="listes-annonces.php?region=17" data-id="17">Melaky</a></li>
			<li><a href="listes-annonces.php?region=18" data-id="18">Menabe</a></li>
			<li><a href="listes-annonces.php?region=19" data-id="19">Sava</a></li>
			<li><a href="listes-annonces.php?region=20" data-id="20">Sofia</a></li>
			<li><a href="listes-annonces.php?region=21" data-id="21">Vakinankaratra</a></li>
			<li><a href="listes-annonces.php?region=22" data-id="22">Vatovavy-Fitovinany</a></li>
		</ul>
...
<div class="list-premium">
	...
	<br>
	<center><a href="listes-annonces.php" class="btn button">Voir tous les annonces</a></center>
...
<div class="container-100 categories">
	...
	?>
        <li><a href="categorie.php?id=<?php echo $res_vehicules['id'];?>"><?php echo $res_vehicules['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
	...
	?>
        <li><a href="categorie.php?id=<?php echo $res_loger['id'];?>"><?php echo $res_loger['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
	...
	?>
        <li><a href="categorie.php?id=<?php echo $res_emploi['id'];?>"><?php echo $res_emploi['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
		...
		?>
        <li><a href="categorie.php?id=<?php echo $res_mode['id'];?>"><?php echo $res_mode['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
	...
	<?php
		...
		?>
        <li><a href="categorie.php?id=<?php echo $res_hiteck['id'];?>"><?php echo $res_hiteck['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
	...
	<?php
		...
		?>
        <li><a href="categorie.php?id=<?php echo $res_habitation['id'];?>"><?php echo $res_habitation['label'];?></a></li>
	<?php } ?>
	</ul>
	<ul>
	...
	<?php
		...
		?>
        <li><a href="categorie.php?id=<?php echo $res_losirs['id'];?>"><?php echo $res_losirs['label'];?></a></li>
		<?php } ?>
	</ul>
</nav>
</div>

	...
	<script>
		/*$(function () {
			/*$("#options").on("change", function () {
				$(".option-1, .option-2, .option-3, .option-4, .option-5, .option-6, .option-7, .option-8, .option-9, .option-10, .option-11, .option-12, .option-13, .option-14, .option-15").attr("disabled", true).hide();
		...
		function post_annonce(){
            ...
            showLoaderOnConfirm: true
                ...
                $.post('ajax/post_annonce.php', {
					...
					an_annee : an_annee,
					an_energy : an_energy,
					an_vitesse : an_vitesse,
					an_cylinder : an_cylinder,
					an_surface : an_surface,
					an_capacity : an_capacity,
					an_piece : an_piece,
					an_title : an_title,
					an_desc : an_desc,
					an_price : an_price,

  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Modification Annonce <?php echo $aid; ?></h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Modification Annonce</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
    ...
    <section class="content">
      <form action="update-adv.php" method="post">
        <div class="row">
          <div class="col-md-12">
            <div class="card card-primary">
              ...
              <!-- form start -->
              <form action="scripts/update-adv.php" method="post">
                <div class="card-body">
                  <div class="form-group col-sm-6">
                    <label>Titre</label>
                    <input type="text" class="form-control" name="title" placeholder="Entrer le titre" value="<?= $row['an_title'] ?>">
                  </div>
                  <div class="form-group col-sm-6">
                    <label>Description</label>
                    <textarea class="form-control" name="descr" cols="60" rows="10" placeholder="Entrer la description"><?= $row['an_desc'] ?></textarea>
                  </div>
                  <div class="form-group col-sm-6">
                    ...
                    <div class="input-group">
                      ...
                      <input type="text" class="form-control" name="price" placeholder="Enter le prix" value="<?= $row['an_price'] ?>">
                    </div>
                  </div>
                  <div class="form-group col-sm-6">
                    <label for="">Type</label>
                    <?php 
                    $isChecked1 = ($row['an_type'] == 'Offre') ? 'checked="checked"' : '';
                    $isChecked2 = ($row['an_type'] == 'Demande') ? 'checked="checked"' : ''; 
                    ?>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" name="type" <?= $isChecked1; ?> value="Offre">
                      <label class="form-check-label" for="">Vendre</label>
                    </div>
                    <div class="form-check">
                      <input type="radio" class="form-check-input" name="type" <?= $isChecked2; ?> value="Demande">
                        ...
                        while($row = $result->fetch_assoc()) {
                          ...
                          if ($result_->num_rows > 0) {
                            ...
                            while($row_ = $result_->fetch_assoc()) {
                              $isSelected = ($row_['id'] === $row['an_souscat']) ? 'selected="selected"' : '';
                              echo '<option value="' .$row_['id']. '" ' .$isSelected. '>' .$row_['label']. '</option>';
                            }
                          } else {
                            echo "0 results";
                          }
              ...
              <!--label for="an_annee[]" class="error" style="display:none;">Please choose one.</label-->
                        ...
                        <input class="form-control option-1" type="text" id="an_kmeterv" name="an_kmeterv" placeholder="Kilométrage" value="<?= $row['an_kmeterv'] ?>">
                      </div>
                      <div class="col-sm-6">
              ...
              <!--label for="an_vitesse[]" class="error" style="display:none;">Please choose one.</label-->
                    ...
                    <div class="row">
                      <div class="col-sm-6">
                        ...
                        <input class="form-control option-2" type="text" id="an_kmeterm" name="an_kmeterm" placeholder="Kilométrage" value="<?= $row['an_kmeterm'] ?>">
              ...
              <!--<label for="an_annee[]" class="error" style="display:none;">Please choose one.</label-->
                      ...
                      <div class="col-sm-6">
                        ...
                        <input class="form-control option-2" type="text" id="an_cylinder" name="an_cylinder" placeholder="Cylindrée" value="<?= $row['an_cylinder'] ?>">
                      </div>
                    </div>
                    <div class="row col-sm-6">
                      <label class="option-3">Kilometrage</label>
                      <input class="form-control option-3" type="text" id="an_kmeterc" name="an_kmeterc" placeholder="Kilométrage" value="<?= $row['an_kmeterc'] ?>">
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <label class="option-8">Surface</label>
                        <input class="form-control option-8" type="number" name="an_surfacevm" id="an_surfacevm" placeholder="Surface de la Maison" value="<?= $row['an_surfacevm'] ?>">
                        <label class="option-8">Nombre de pieces</label>
                        <input class="form-control option-8" type="number" name="an_piecevm" id="an_piecevm" placeholder="Nombre de pieces" value="<?= $row['an_piecevm'] ?>">
                      </div>
                      <div class="col-sm-6">
                        <label class="option-8">Capacite</label>
                        <input class="form-control option-8" type="number" name="an_capacityvm" id="an_capacityvm" placeholder="Capacité de la Maison" value="<?= $row['an_capacityvm'] ?>">    
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <label class="option-9">Surface</label>
                        <input class="form-control option-9" type="number" name="an_surfacelm" id="an_surfacelm" placeholder="Surface de la Maison" value="<?= $row['an_surfacelm'] ?>">
                        <label class="option-9">Nombre de piece</label>
                        <input class="form-control option-9" type="number" name="an_piecelm" id="an_piecelm" placeholder="Nombre de pieces" value="<?= $row['an_piecelm'] ?>">
                      </div>
                      <div class="col-sm-6">
                        <label class="option-9">Capacite</label>
                        <input class="form-control option-9" type="number" name="an_capacitylm" id="an_capacitylm" placeholder="Capacité de la Maison" value="<?= $row['an_capacitylm'] ?>">
                      </div>
                    </div>
                    <div class="row col-sm-6">
                      <label class="option-10">Surface</label>
                      <input class="form-control option-10" type="number" name="an_surfacet" id="an_surfacet" placeholder="Surface du Terrain" value="<?= $row['an_surfacet'] ?>">
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <label class="option-11">Surface</label>
                        <input class="form-control option-11" type="number" name="an_surfacecl" id="an_surfacecl" placeholder="Surface de la Maison" value="<?= $row['an_surfacecl'] ?>">
                        <label class="option-11">Nombre de pieces</label>
                        <input class="form-control option-11" type="number" name="an_piececl" id="an_piececl" placeholder="Nombre de pieces" value="<?= $row['an_piececl'] ?>">
                      </div>
                      <div class="col-sm-6">
                        <label class="option-11">Capacite</label>
                        <input class="form-control option-11" type="number" name="an_capacitycl" id="an_capacitycl" placeholder="Capacité de la Maison" value="<?= $row['an_capacitycl'] ?>">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <label class="option-12">Debut</label>
                        <input class="form-control option-12" type="date" name="an_debutlv" id="an_debutlv" placeholder="Debut du Location" value="<?= $row['an_debutlv'] ?>">
                        <label class="option-12">Fin</label>
                        <input class="form-control option-12" type="date" name="an_finlv" id="an_finlv" placeholder="Fin du Location" value="<?= $row['an_finlv'] ?>">
                        <label class="option-12">Surface</label>
                        <input class="form-control option-12" type="number" name="an_surfacelv" id="an_surfacelv" placeholder="Surface de la Maison" value="<?= $row['an_surfacelv'] ?>">
                      </div>
                      <div class="col-sm-6">
                        <label class="option-12">Nombre de pieces</label>
                        <input class="form-control option-12" type="number" name="an_piecelv" id="an_piecelv" placeholder="Nombre de pieces" value="<?= $row['an_piecelv'] ?>">
                        <label class="option-12">Capacite</label>
                        <input class="form-control option-12" type="number" name="an_capacitylv" id="an_capacitylv" placeholder="Capacité de la Maison" value="<?= $row['an_capacitylv'] ?>">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <label class="option-13">Surface</label>
                        <input class="form-control option-13" type="number" name="an_surfacel" id="an_surfacel" placeholder="Surface du Locaux" value="<?= $row['an_surfacel'] ?>">
                      </div>
                      <div class="col-sm-6">
                        <label class="option-13">Nombre de pieces</label>
                        <input class="form-control option-13" type="number" name="an_piecel" id="an_piecel" placeholder="Nombre de pieces" value="<?= $row['an_piecel'] ?>">
                      </div>
                    </div>
                    <div class="row col-sm-6">
                      <label class="option-14">Surface</label>
                      <input class="form-control option-14" type="number" name="an_surfaceg" id="an_surfaceg" placeholder="Surface du Garage" value="<?= $row['an_surfaceg'] ?>">
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                        <label class="option-15">Surface</label>
                        <input class="form-control option-15" type="number" name="an_surfacebc" id="an_surfacebc" placeholder="Surface du Bureau" value="<?= $row['an_surfacebc'] ?>">
                      </div>
                      <div class="col-sm-6">
                        <label class="option-15">Nombre de pieces</label>
                        <input class="form-control option-15" type="number" name="an_piecebc" id="an_piecebc" placeholder="Nombre de pieces" value="<?= $row['an_piecebc'] ?>">
                      </div>
                    </div>
                    <div class="row col-sm-6">
                    ...
                    <div class="row">
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="number" name="an_nombref" id="an_nombref" placeholder="Nombre des films" class="form-control option-30" value="<?= $row['an_nombref'] ?>">
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-sm-6">
                      ...
                      <div class="col-sm-6">
                        ...
                        <input type="number" name="an_nombrem" id="an_nombrem" placeholder="Nombre des musiques" class="form-control option-31" value="<?= $row['an_nombrem'] ?>">
                      </div>
                    </div> 
                  </div>
                  <div class="form-group col-sm-12">
                      ...
                      <div class="col-sm-6">
                        ...
                        <select class="form-control" name="region">
                          ...
                          if ($result->num_rows > 0) {
                            // output data of each row
                            while($row = $result->fetch_assoc()) {
                              $isSelected = ($row_['id'] === $row['an_region']) ? 'selected="selected"' : '';
                              echo '<option value="' .$row['id']. '" ' .$isSelected. '>' .$row['label']. '</option>';
                            }
                          } else {
                            echo "0 results";
                          }
                        ...
                        <p>Ville</p>
                        <input type="text" name="city" class="form-control" placeholder="Entrer la ville" value="<?= $row['an_city'] ?>">
                        <p>Code postal</p>
                        <input type="text" name="code" class="form-control" placeholder="Entrer le code postal" value="<?= $row['an_postcode'] ?>">
                        <p>Adresse</p>
                        <input type="text" name="address" class="form-control" placeholder="Entrer l'adresse" value="<?= $row['an_address'] ?>">
                      </div>
                      <div class="col-sm-6">
                        <div id="disp-map"></div>
                      </div>
...
?>
<script type="text/javascript" src="js/edit_adv.js"></script>
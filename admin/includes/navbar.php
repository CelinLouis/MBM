  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item dropdown user-menu">
      <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
        ...
        <span class="d-none d-md-inline"><?= $_SESSION['user'][0]['first_name'] . ' ' . $_SESSION['user'][0]['last_name']; ?></span>
      </a>
      <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
        ...
        <li class="user-header bg-primary">
          ...
          <p>
            <?= $_SESSION['user'][0]['first_name'] . ' ' . $_SESSION['user'][0]['last_name']; ?>
        ...
        <li class="user-footer">
          ...
          <a href="logout.php" class="btn btn-default btn-flat float-right">Se deconnecter</a>
        </li>
      </ul>
    </li>
    <li class="nav-item">

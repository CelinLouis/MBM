...
<?php 
 ...
 ?>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Modifier d'une ville</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
            ...
            <div class="card card-success">
              ...
              <form action="" method="post">
                ...
                <div class="card-footer">
                  <button type="submit" class="btn btn-info float-right" name="submit">Modificateur</button>
                </div>
                <!-- /.card-footer -->
              </form>
            </div>
  ...
  if (isset($_GET['sid'])) {
        ...
        $sql = "INSERT INTO `an_ville` (`id`, `Label`, `id_region`) VALUES ('', '".$cat."', '".$title."') ";

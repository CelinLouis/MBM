...
date_fr FROM an_annonces WHERE id_membres=".$uid;
    ...
    <section class="content">
      	...
      	<div class="card">
            <div class="card-header">
              <h3 class="card-title">Liste de toutes les annonces</h3>
	                		...
	                		if ($result->num_rows > 0) {
								while($row = $result->fetch_assoc()) {
						            ...
						            echo "<td>".ucfirst($row['an_city'])."</td>
						                  	...
						                  	<td>".strtoupper($row['an_payment']).' et '.strtolower($row['an_status'])."</td>
						                  	<td>".$row['date_fr'].'</td>
						                  	<td class="btn-group btn-group-sm">
		                						<a href="adDetail.php?aid='.$row['id'].'" class="btn btn-info"><i class="fas fa-eye"></i></a>
